...
Future<void> main() async {
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZzZ3Jua3NsZ3hvaHZzYWNzcG14Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE3MjY1MjIsImV4cCI6MjA0NzMwMjUyMn0.cP8Ki-w1uC1-HZl2zGB9RloM8Sn1TzIZLVMSkkHrVv0',
  );
  runApp(const MyApp());
}
